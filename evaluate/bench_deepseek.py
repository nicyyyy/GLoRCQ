#!/usr/bin/env python3
"""Stable bs=1 decode throughput for DeepSeek MoE models: warmup-discard + N timed
...
REAL = "./outputs/deepseek/real_quant"
FP16 = "deepseek-ai/deepseek-moe-16b-base"
...
def main():
    ...
    ap.add_argument("--real_path", default=REAL,
                    help="real-quant checkpoint dir")
    ap.add_argument("--fp16_path", default=FP16,
                    help="fp16 baseline model dir or HF id")
    args = ap.parse_args()
