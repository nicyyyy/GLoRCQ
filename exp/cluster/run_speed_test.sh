#!/bin/bash
# Real-quant decode-speed benchmark (post-NaN-fix) for the 3 models.
# Each: eval_speed.py prints standard + CUDA-graph tok/s. GPU4, tmux test:0.
set -uo pipefail
