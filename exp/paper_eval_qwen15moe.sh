...
#
#   Step 0a: Fake-quant (SOTA config)        (~60 min, GPU ≥24 GB)
#   Step 0b: Real-quant (for speed test)     (~60 min, GPU ≥24 GB)
#   Step 1:  WikiText-2 PPL                  (~15 min)
#   Step 2:  Zero-shot 5 tasks (0-shot)      (~30 min)
#   Step 3:  MMLU (5-shot)                   (~60 min)
...
#
# SOTA config (E5, PPL=7.55, 3.2270 bits):
...
#
# Example:
#   bash exp/paper_eval_qwen15moe.sh /data/glorcq_qwen15moe 0
#
# Requirements:
...
if ! command -v docker &> /dev/null; then
    ...
    cp "logs/vllm_bench_qwen1.5-moe-a2.7b.json" \
